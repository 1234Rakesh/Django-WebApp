...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('App_item', '0002_alter_category_options_item'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversation', to='App_item.item')),
